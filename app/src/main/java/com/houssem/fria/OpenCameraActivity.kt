...
import com.houssem.fria.Help.HelpActivity
import com.houssem.fria.ar.MyArFragment
import com.houssem.fria.catalog.CatalogFrontActivity
import com.houssem.fria.greetings.GreetingActivity
import com.houssem.fria.greetings.SquareImageButton
import com.houssem.fria.utils.PhotoSaver
import com.houssem.fria.utils.VideoRecorder
import com.warkiz.widget.IndicatorSeekBar
import com.warkiz.widget.IndicatorStayLayout
import com.warkiz.widget.OnSeekChangeListener
import com.warkiz.widget.SeekParams
import es.dmoral.toasty.Toasty
import kotlinx.android.synthetic.main.camera_top_panel.*
import java.io.File
import java.util.*
...
class OpenCameraActivity : AppCompatActivity() {
    ...
    private fun setupLogoutButton() {
        ...
        logoutBtn.setOnClickListener { view ->
             ...
             */
            //val sharedPreferences = this.getSharedPreferences("my_app", Context.MODE_PRIVATE)
            val editor = getSharedPreferences("my_app", Context.MODE_PRIVATE).edit()
            editor.remove(Utils.TOKEN)
            editor.remove(Utils.EXPIRY_TIME.toString())
            editor.apply()
    ...
    private fun setupFavoriteButton(){
        ...
        myFavoritesButton.setOnClickListener {
   ...
   */
    ...
    private fun toggleRecording() {
        ...
        if (recording) {
            ...
            recordButton.setImageResource(R.drawable.ic_baseline_stop)
        } else {
